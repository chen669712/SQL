...
left join ods_htl_bnborderdb.order_header_v2 b1 on a1.orderid=b1.orderid and b1.d='2018-07-22'
left join ods_htl_bnborderdb.order_item_space c1 on c1.orderitemid=a1.orderitemid and c1.d='2018-07-22'
where substring(b1.createdtime,0,10) ='2018-07-21'
  and a1.d='2018-07-22'
...
--and bnbpay_d.cityid=search_d.cityid
left outer join
--日城市客栈订单
(select to_date(orderdate) as d
  , orderid
...
--and hotelpay_d.cityid=search_d.cityid
--left outer join ods_htl_groupwormholedb.bnb_city city on pay_d.cityid = city.cityid and city.d = '2018-07-22'
group by pay_d.cityid
...
left outer join ods_htl_groupwormholedb.bnb_city city on search_d.cityid = city.cityid and city.d = '2018-07-22'
